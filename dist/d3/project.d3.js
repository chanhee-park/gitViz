...
function keywordRankingVis(params) {
            ...
            _.forEach(allYearList, function (year) {
                ...
                if (ranking > 0) {
                    ...
                    if (lineData.length > 3) {
                        var pathG = g.append("path").attr("d", lineBasis(lineData)).attrs({
                            fill: 'none',
    ...
    // 키워드 추출
    var keywordsByYears = getRankingData(projectsData);
